...
// Move hands
var panPos = 100;
var tween2_3 = TweenMax.to("#imghands", 1, {x: -winx});
...
//blue line
var tween3_9 = TweenMax.to("#sec04_blueline", 1, {y: winy*4, ease:Power1.easeInOut});
var scene3_9 = new ScrollMagic.Scene({
	triggerElement: "#sec04_blueline", 
	duration: winy*4.5, 
	offset: 0,
}).setTween(tween3_9)
.addTo(controller);
...
var timelinedrops = new TimelineMax()
	.add(TweenMax.to(".imgdrop1", 1, {y: winy, opacity: 1}))
	.add(TweenMax.to(".imgdrop2", 1, {y: winy, opacity: 1}), '-=.9')
	.add(TweenMax.to(".imgdrop3", 1, {y: winy, opacity: 1}), '-=.9')
...
// rolling logo
var tween6_2 = TweenMax.to("#sec06_01", 1, {rotate: 360, x: winx});
